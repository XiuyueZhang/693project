...
const classes = [
  ...
  },
  {
    ...
    level: 'Professional',
    videoPath: '/videos/ibm-certified-cloud-solution-architect-v3.mp4https://cloudtech-project-videos.s3.ap-southeast-2.amazonaws.com/yt5s.io+The+Dark+Plum+Sauce+Official+Music+Video.mp4',
    category: 'ibm',
    isActive: true,
  ...
  },
  {
    ...
    level: 'Expert',
    videoPath: '/videos/microsoft-certified-azure-solutions-architect-expert.mp4https://cloudtech-project-videos.s3.ap-southeast-2.amazonaws.com/yt5s.io-+Beginning+of+the+End+Official+Music+Video.mp4',
    category: 'azure',
    isActive: true,
